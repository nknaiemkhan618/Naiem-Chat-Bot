...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    ...
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ Nk Naiem Khan☜\nFacebook: https://www.facebook.com/nk.naiem.khan.641816\nWhatsApp: +8801908143017",
    "admin": "He is Nk Naiem Khan তাকে সবাই Cyber Bot Team Saport Admin হিসেবে চিনে😘☺️",
    ...
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌না্ঁঈ্ঁমে্ঁর্ঁ ফে্ঁমা্ঁস্ঁ ব্ঁট্ঁ💖",
    "pic de": "এন থেকে সর দুরে গিয়া মর😒",
    "cudi": "এত খারাপ ভাষা বলিস  কেনো..!🥱🌝🌚",
    "bal": "রাগ করে না সোনা পাখি 🥰",
    "heda": "এতো রাগ শরীরের জন্য ভালো না 🥰",
    "boda": "ভাই তুই এত হাসিস না..!🌚🤣",
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss নাঈম এর ইনবক্সে গুতা দিন 😘",
